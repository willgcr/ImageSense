...
const Footer = () => {
	return (
		<div className="flex justify-center py-10">
			<div className="flex flex-col items-center space-y-1 justify-center text-gray-250 px-8 py-0 max-w-4xl mx-auto text-xs">
				<span className="text-center text-gray-500">This app is a prototype.<a href="https://github.com/willgcr/ImageSense" target="_blank">Check it out on GitHub.</a></span>
